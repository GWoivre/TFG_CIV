...
-----------------------------------------------	
	...
	('en_US',	'LOC_AGENDA_GWG_CHIFFRE_NAME',	'Gambling'	),
	('en_US',	'LOC_AGENDA_GWG_CHIFFRE_DESCRIPTION',	'Gambling'	),
	
	('en_US',	'LOC_DIPLO_KUDO_LEADER_GWG_CHIFFRE_REASON_ANY',	'(Gambling)'	),
	('en_US',	'LOC_DIPLO_MODIFIER_GWG_CHIFFRE_HAPPY',	'Gambling'	),
	
	('en_US',	'LOC_DIPLO_WARNING_LEADER_GWG_CHIFFRE_REASON_ANY',	'Gambling'	),
	('en_US',	'LOC_DIPLO_MODIFIER_GWG_CHIFFRE_UNHAPPY',	'Gambling'	),
